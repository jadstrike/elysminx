...
export const EmailTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>The marketplace for modern digital goods.</Preview>
      <Body style={main}>
        <Container style={container}>
          <Img
            ...
            width="150"
            height="150"
            alt="Elysminx Digital MarketPlace"
            style={logo}
          />
          <Text style={paragraph}>Hi there,</Text>
          <Text style={paragraph}>
            Welcome to Elysminx, the marketplace for high quality digital goods.
